...
# Paths absolutos
print(os.path.exists('/home/ilanrose/university'))  # False
print(os.path.exists('/home/ilanrose/Imagens'))  # True
print(os.path.exists('/home/ilanrose/Imagens/wallpaler2.png'))  # True
...
os.mknod('arquivo-5.txt')

os.mknod('/home/ilanrose/university.txt')
...
# Path Absoluto
os.mkdir('/home/ilanrose/templates')
